...
export const UserProvider = ({ children }: iUserContextProps) => {
    ...
    const [openModalUpdateProfile, setOpenModalUpdateProfile] =
        useState<boolean>(false);
    const [openModalUpdateAddress, setOpenModalUpdateAddress] =
        useState<boolean>(false);
    const [openModalConfirmDeleteUser, setOpenModalConfirmDeleteUser] =
        useState<boolean>(false);
    ...
    const onSubmitFormUpdateUserAddress = async (data: iUpdateAddress) => {
        const id = localStorage.getItem("@ID");
        const token = JSON.parse(localStorage.getItem("@TOKEN")!);
