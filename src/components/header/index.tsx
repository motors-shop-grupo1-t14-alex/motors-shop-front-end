        ...
        <header className="flex justify-center border-b-2 border-gray-300 font-medium h-20">
            <div className="flex items-center justify-between h-full w-9/10 max-w-screen-2xl">
                ...
                {screenSize < 768 ? (
                    <button
                        onClick={toggleMenu}
                        className="block md:hidden py-3 focus:outline-none group rounded-[10px]"
                    >
                        {menu ? (
                        ...
                        <div
                            className={`${openMenu()} absolute z-10 top-20 right-0 h-40 w-full bg-white border rounded-b-[2.5px]`}
                        >
                            <ul className="flex gap-5 flex-col items-center w-full pt-10">
                                <li className="w-9/10 flex justify-start">
